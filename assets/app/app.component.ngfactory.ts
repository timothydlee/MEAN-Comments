...
class _View_AppComponent_Host0 extends import1.AppView<any> {
  ...
  get _MessageService_0_5():import4.MessageService {
    if ((this.__MessageService_0_5 == (null as any))) { (this.__MessageService_0_5 = new import4.MessageService(this.parentInjector.get(import9.Http),this.parentInjector.get(import10.ErrorService))); }
...
class _View_AppComponent0 extends import1.AppView<import3.AppComponent> {
  ...
  _HeaderComponent_2_4:import13.HeaderComponent;
  _text_3:any;
  _el_4:any;
  _text_5:any;
  _el_6:any;
  /*private*/ _appEl_6:import2.AppElement;
  _RouterOutlet_6_5:import14.RouterOutlet;
  _text_7:any;
  _text_8:any;
  _el_9:any;
  /*private*/ _appEl_9:import2.AppElement;
  _ErrorComponent_9_4:import15.ErrorComponent;
  constructor(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement) {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._RouterOutlet_6_5 = new import14.RouterOutlet(this.parentInjector.get(import17.RouterOutletMap),this._appEl_6.vcRef,this.parentInjector.get(import18.ComponentFactoryResolver),(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import13.HeaderComponent) && (2 === requestNodeIndex))) { return this._HeaderComponent_2_4; }
    if (((token === import14.RouterOutlet) && (6 === requestNodeIndex))) { return this._RouterOutlet_6_5; }
    if (((token === import15.ErrorComponent) && (9 === requestNodeIndex))) { return this._ErrorComponent_9_4; }
    return notFoundResult;
  }
...
export function viewFactory_AppComponent0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AppComponent> {
  if ((renderType_AppComponent === (null as any))) { (renderType_AppComponent = viewUtils.createRenderComponentType('C:/Users/timot/Documents/Coding/Udemy/MEAN/MEAN-CommentsApp/assets/app/app.component.html',0,import11.ViewEncapsulation.None,styles_AppComponent,{})); }
