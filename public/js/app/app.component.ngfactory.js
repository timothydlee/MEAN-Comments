...
var _View_AppComponent_Host0 = (function (_super) {
    ...
    Object.defineProperty(_View_AppComponent_Host0.prototype, "_MessageService_0_5", {
        get: function () {
            if ((this.__MessageService_0_5 == null)) {
                (this.__MessageService_0_5 = new import4.MessageService(this.parentInjector.get(import9.Http), this.parentInjector.get(import10.ErrorService)));
            }
    ...
    _View_AppComponent_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import4.MessageService) && (0 === requestNodeIndex))) {
            return this._MessageService_0_5;
        }
...
export var AppComponentNgFactory = new import12.ComponentFactory('my-app', viewFactory_AppComponent_Host0, import3.AppComponent);
...
var _View_AppComponent0 = (function (_super) {
    ...
    _View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._HeaderComponent_2_4 = new import13.HeaderComponent();
        ...
        this._RouterOutlet_6_5 = new import14.RouterOutlet(this.parentInjector.get(import17.RouterOutletMap), this._appEl_6.vcRef, this.parentInjector.get(import18.ComponentFactoryResolver), null);
        ...
        var compView_9 = import19.viewFactory_ErrorComponent0(this.viewUtils, this.injector(9), this._appEl_9);
        this._ErrorComponent_9_4 = new import15.ErrorComponent(this.parentInjector.get(import10.ErrorService));
    ...
    _View_AppComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import13.HeaderComponent) && (2 === requestNodeIndex))) {
            return this._HeaderComponent_2_4;
        }
        if (((token === import14.RouterOutlet) && (6 === requestNodeIndex))) {
            return this._RouterOutlet_6_5;
        }
        if (((token === import15.ErrorComponent) && (9 === requestNodeIndex))) {
...
export function viewFactory_AppComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AppComponent === null)) {
        (renderType_AppComponent = viewUtils.createRenderComponentType('C:/Users/timot/Documents/Coding/Udemy/MEAN/MEAN-CommentsApp/assets/app/app.component.html', 0, import11.ViewEncapsulation.None, styles_AppComponent, {}));
    }
